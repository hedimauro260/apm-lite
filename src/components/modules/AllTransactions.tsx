...
} from '../modals/AddTransactionModal';
import {
    EditTransactionModal,
    type EditTransactionData,
} from '../modals/EditTransactionModal';
...
export function AllTransactions() {
    ...
    const handleUpdateTransaction = async (
        ...
        const updates: Partial<Transaction> = {
            ...
            description: data.description,
            website: data.website,
            countsTowardsGoals: data.countsTowardsGoals,
    ...
    useEffect(() => {
        setCurrentPage(1);
    }, [filterTime, filterType, filterWallet, searchQuery]);
    ...
    return (
        <div className="card h-full flex flex-col overflow-hidden">
            <div className="flex items-center justify-between px-6 py-4 border-b border-border">
                <div>
                    <h2 className="text-xs font-semibold text-text-primary">All Transactions</h2>
                </div>
