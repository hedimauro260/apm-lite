...
export function SummaryCard({
    ...
    const displayVariation = variation !== undefined ? formatPercentage(variation) : undefined;

    return (
        <div className={cn('card p-6 flex flex-col justify-between h-full', className)}>
            <div>
                ...
                {displayVariation && (
                    <div className={cn('flex items-center gap-1 text-xs font-medium mb-4', trendColor)}>
